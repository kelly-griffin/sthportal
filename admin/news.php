...
<body>
  <div class="site">
    ...
    <div class="canvas">
      <div class="news-container news-admin">
        <div class="news-card">
          <main class="news-content">
            <section class="news-content-col">
              <div class="news-title"><span>Manage News</span></div>
              <div class="toolbar">
                <a class="btn" href="news-new.php">+ New Article</a>
                <a class="btn" href="news-auto-recap.php">⚡ Auto Recap</a>
              </div>
