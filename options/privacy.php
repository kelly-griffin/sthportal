      ...
      <div class="privacy-container">
        <div class="privacy-card">
          <div class="page-surface">
            <h1><?= h($title) ?></h1>
            <p class="muted">Control local data, consent, and what (if anything) the portal should collect. UI only for
              now; nothing is sent anywhere.</p>
            ...
            <div class="grid2">
              ...
              <section class="card" id="collection">
                ...
                <div class="col">
                  ...
                  <label class="chk"><input type="checkbox" id="pErrors"> Allow error & crash reports
                    (anonymous)</label>
                </div>
                <div class="hr"></div>
                <button class="btn small" type="button" id="resetCollection">Reset</button>
                <p class="muted" style="margin-top:8px;">Stored as <code>portal:privacy:analytics</code> and
                  <code>portal:privacy:errors</code>.</p>
              </section>
              ...
              <section class="card" id="personalization">
                ...
                <div class="col">
                  <label class="chk"><input type="checkbox" id="pPersonalize"> Personalized UI (remember team/scope,
                    quick filters)</label>
                  <label class="chk"><input type="checkbox" id="pRemember" disabled> “Remember me” on this device <span
                      class="muted">(server wiring later)</span></label>
                </div>
                <div class="hr"></div>
                <button class="btn small" type="button" id="resetPersonal">Reset</button>
                <p class="muted" style="margin-top:8px;">Stored as <code>portal:privacy:personalize</code> and
                  <code>portal:privacy:remember</code>.</p>
              </section>
              ...
              <section class="card" id="consent">
                ...
                <p class="muted" style="margin-top:8px;">Stored as <code>portal:privacy:consent</code> and
                  <code>portal:privacy:cookie-banner</code>.</p>
              </section>
              ...
              <section class="card" id="localdata">
                ...
                <p class="muted" style="margin-top:8px;">“Clear Portal Storage” removes all <code>localStorage</code>
                  keys beginning with <code>portal:</code>.</p>
              </section>
              ...
              <section class="card" id="access">
                ...
                <div class="row">
                  ...
                  <a class="btn small" href="#" aria-disabled="true" onclick="return false;">Delete My Account
                    (soon)</a>
                </div>
              </section>
              ...
              <section class="card" id="policy">
                <h2>Policy</h2>
                <p class="muted">Draft: no third-party trackers, no ads, no sale of data. Any future collection will be
                  opt-in and documented here.</p>
              </section>
            </div>
          </div>
        </div>
