...
$title = 'World Junior Hockey Championships';
?>
<!doctype html>
<html lang="en">
<meta charset="utf-8">
...
require __DIR__ . '/home-leaders.php'; */ ?>
                    ...
                    <main class="centre">
                        ...
                        <section class="feature">
                            ...
                            <div class="overlay">
                                <h3 id="feature-headline">Welcome to World Junior Hockey.</h3>
                    ...
                    <aside class="sidebar-right">
                        ...
                        <div class="box" id="scoresCard">
                            <div class="title">World Junior Scores</div>
                        ...
                        <div id="standingsCard" class="box standings-box" data-season-games="84">
                            <div class="title">World Junior Standings</div>
