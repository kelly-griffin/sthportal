// UHA Portal — tournaments interactions
// assets/js/playoffs.js — stable reset (ticker + feature + leaders + tx toggle + log link normalizer)
// No jQuery. No unknown globals. 
...
(() => {
  ...
  function initFeature() {
    ...
    setText('#feature-headline', f.headline || 'Welcome to the Tournament.');
